    ...
    <div class="node-container">
        ...
        <main class="nodrag">
            <div class="left">
                ...
                <div class="handle-container">
                    <Handle id="in-color" type="target" :connectable="1" :position="Position.Left"
                        :is-valid-connection="onConnect" class="handle"
                        style="background-color: #fff;border-color: #fff;border-radius: 0;">
                        <p>1</p>
                    </Handle>
                    <div class="handle"></div>
                    <Input v-model="color" placeholder="color" :disabled="attrs.data.colorHandle"></Input>
                </div>
            </div>
        </main>
    </div>
...
const color = toRef(attrs.data, "color");
