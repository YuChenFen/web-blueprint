        ...
        <main class="nodrag">
            <div class="left">
                <div class="handle-container">
                    ...
                    <Input v-model="value1" placeholder="值" :disabled="attrs.data.value1Handle"></Input>
                </div>
                <div class="handle-container">
                    ...
                    <div class="handle"></div>
                    <Input v-model="value2" placeholder="值" :disabled="attrs.data.value2Handle"></Input>
                </div>
            </div>
            <div class="right">
                <div class="handle-container">
...
const strict = toRef(attrs.data, "strict");

attrs.data.output = computed(() => {
    return `(${value1.value} ==${strict.value ? "=" : ""} ${value2.value})`
});
